            ...
            <tbody id="sort-items" data-table="<?=$db_table?>">
               <?php foreach ($data as $item): ?>
                  <tr id="<?=$item['id']?>">
                     ...
                     <td class="t-border" style="width:30px;"> 
                        <?php if ($item['view_home'] == 1): ?>
                        <input checked onclick="buttonView(this, '<?=$db_table?>', '<?=$item['id']?>', 'view_home')" class="checkbox" name="view" type="checkbox"> 
                        <?php else: ?>
                        <input onclick="buttonView(this, '<?=$db_table?>', '<?=$item['id']?>', 'view_home')" class="checkbox" name="view" type="checkbox">
                        <?php endif ?>  
                     </td> 
