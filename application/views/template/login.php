...
<div class="content">
   ...
   <form class="login-form" action="/cp/do-login/" method="POST">
      <div class="logo-content">
         <h1>Log In</h1> 
      </div> 
      <div class="alert display-hide" id="respond_login"> </div>
      ...
      <div class="form-actions" style="border-bottom:none;">
         ...
         <button type="submit" class="btn green-haze pull-right" id="btn-lgn">
